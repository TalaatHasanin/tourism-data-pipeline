...
def load_from_mongodb(*args, **kwargs):
    ...
    df = df.drop(columns=['__v', 'password', 'slug', 'customId', 'confirmed', 
    'forgetPassword', 'preferences', 'token', 'favouriteEntertainmentPlaces', 
    'favouriteHistoricPlaces', 'trips', 'countryFlag', 'profilePicture', 
    'coverPicture', 'resetCode', 'socketID', 'devicePushToken', 'provider'])
